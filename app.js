...
const { lowerCase, kebabCase } = require("lodash");
...
app.get("/posts/:title" , function (req , res) {
  ...
  posts.forEach(function(post){
    ...
    const lowerCaseStoredTitle = lodash.lowerCase(storedTitle);

    if (lowerCaseStoredTitle === requestedTitle) {

      res.render("post" , { postTitle:storedTitle , postContent:post.postBody})
    }else{
